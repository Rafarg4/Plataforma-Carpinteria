<input type="hidden" name="_token" value="{{ csrf_token() }}" id="token">
	...
	<div class="col-md-4">
		...
		<div class="form-group">
			<label for="vent_iva">IVA</label>			
			<select name="vent_iva" id="vent_iva" class="form-control">
...
<script>
	...
	function agregar(){
		...
		iva =   $("#vent_iva option:selected").val();
		//Validar los campos
